...
const AdminLoginPage: React.FC = () => {
  ...
  const fillTestCredentials = () => {
    setValue("email", "admin@streamvibe.com");
        ...
        <div className="bg-surface border border-border-darker rounded-[12px] p-8">
          ...
          >
            ...
            <button
              ...
              className="bg-surface border border-border-darker text-text-s font-medium text-[14px] rounded-[8px] py-3 hover:bg-border-darker hover:text-text-p transition-colors"
            >
